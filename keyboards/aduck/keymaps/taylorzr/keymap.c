...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_COLEMAKDH] = LAYOUT( \
			...
			ALT_T(KC_A), GUI_T(KC_R), GUI_T(KC_S), SFT_T(KC_T),   KC_G,             /*******/ KC_M,            SFT_T(KC_N),     KC_E,    KC_I,   KC_O,    \
	...
	[_SFT] = LAYOUT( \
			...
			/*___*/  /*___*/  /*___*/  _______, _______, /*******/ _______, TD(CLN)  \
			),
	...
	[_SYM] = LAYOUT( \
			...
			/*___*/   /*___*/   /*___*/     KC_GRV,     _______,   /*******/ _______, S(KC_GRV)    \
			),
