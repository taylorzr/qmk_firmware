...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT( \
    ...
    LSFT_T(KC_LBRC), KC_Z,   KC_X,   KC_C,    KC_V,     KC_B,           TD(TD_LBRC_HOME), /*******/ TD(TD_RBRC_END), KC_N,              KC_M,    KC_COMM, KC_DOT, KC_SLSH, RSFT_T(KC_RBRC), \
  ...
  [_COLEMAK] = LAYOUT( \
    ...
    LSFT_T(KC_LBRC), KC_Z,   KC_X,   KC_C,    KC_D,     KC_V,           TD(TD_LBRC_HOME), /*******/ TD(TD_RBRC_END), KC_K,              KC_H,    KC_COMM, KC_DOT, KC_SLSH, RSFT_T(KC_RBRC), \
    /*___*/          /*___*/ /*___*/ KC_LEFT, KC_RIGHT, LGUI_T(KC_ESC), KC_BSPC,          /*******/ KC_SPC,          LT(_RAISE,KC_ENT), KC_DOWN, KC_UP    \
  ),
  ...
  [_KYRIA] = LAYOUT( \
    ...
    LALT_T(KC_TAB),  KC_Q,   KC_W,   KC_E,    KC_R,     KC_T,           /*___*/  /*******/  /*___*/ KC_Y,              KC_U,    KC_I,    KC_O,   KC_P,    KC_BSLASH,       \
    LCTL_T(KC_GRV),  KC_A,   KC_S,   KC_D,    KC_F,     KC_G,           /*___*/  /*******/  /*___*/ KC_H,              KC_J,    KC_K,    KC_L,   KC_SCLN, KC_QUOT,         \
    LSFT_T(KC_LBRC), KC_Z,   KC_X,   KC_C,    KC_V,     KC_B,           KC_NO,   /*******/  KC_NO,  KC_N,              KC_M,    KC_COMM, KC_DOT, KC_SLSH, RSFT_T(KC_RBRC), \
    /*___*/          /*___*/ /*___*/ KC_LEFT, KC_RIGHT, LGUI_T(KC_ESC), KC_BSPC, /*******/  KC_SPC, LT(_RAISE,KC_ENT), KC_DOWN, KC_UP    \
  ),
  ...
  [_RAISE] = LAYOUT( \
    ...
    BRACES,   LSFT(KC_1),  LSFT(KC_2),   LSFT(KC_3), LSFT(KC_4), LSFT(KC_5), /*___*/  /*******/ /*___*/  LSFT(KC_6), LSFT(KC_7), LSFT(KC_8), LSFT(KC_9), LSFT(KC_0), PARENS,  \
    BRACKETS, _______,     _______,      _______,    KC_LEFT,    KC_RIGHT,   KC_HOME, /*******/ KC_END,  KC_DOWN,    KC_UP,      _______,    _______,    _______,    _______, \
     /*___*/  /*___*/      /*___*/       _______,    _______,    KC_DEL,     _______, /*******/ _______, _______,    KC_SLEP,    _______     \
  ),
