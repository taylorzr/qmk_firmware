...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT( \
    ...
    LALT(KC_EQL),   KC_Q,   KC_W,   KC_E,    KC_R,    KC_T,            /*___*/            /*******/ /*___*/            KC_Y,         KC_U,    KC_I,    KC_O,   KC_P,    LALT(KC_MINS),     \
    ...
    /*___*/         /*___*/ /*___*/ _______, _______, LGUI_T(KC_BSPC), LT(_RAISE,KC_SPC), /*******/ LT(_LOWER,KC_ENT), LSFT(KC_ESC), _______, _______  \
  ),
  ...
  [_LOWER] = LAYOUT( \
    ...
    /*___*/  /*___*/      /*___*/     _______,       _______,       KC_BSPC,    MO(_NAV), /*******/ _______, _______,    _______,    _______     \
  ),
  ...
  [_RAISE] = LAYOUT( \
    ...
    _______, _______, LGUI(LSFT(LCTL(KC_4))), LSFT(KC_9),    LSFT(KC_0),    KC_HOME, /*___*/   /*******/ /*___*/  KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, _______, _______, \
    _______, _______, _______,                LSFT(KC_LBRC), LSFT(KC_RBRC), KC_END,  XXXXXXX,  /*******/ XXXXXXX, _______, _______, _______, _______,  _______, _______, \
    /*___*/  /*___*/  /*___*/                 _______,       _______,       _______, _______, /*******/ MO(_NAV), _______, _______, _______  \
  ),

  [_NAV] = LAYOUT( \
    _______, _______, _______,      _______,       _______,       _______, /*___*/  /*******/ /*___*/  _______,       _______,       _______,     _______,        _______, _______, \
    _______, _______, LCA(KC_U),    LCA(KC_UP),    LCA(KC_I),     _______, /*___*/  /*******/ /*___*/  KC_MPLY,       KC_VOLD,       KC_VOLU,     KC_MNXT,        _______, _______, \
