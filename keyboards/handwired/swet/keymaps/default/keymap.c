...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_default( \
    ...
    /*___*/         /*___*/ /*___*/ /*___*/ LALT_T(KC_ESC), LCTL_T(KC_BSPC), /*******/ LT(_LOWER,KC_SPC), LT(_RAISE,KC_ENT) \
  ),

  [_BETA] = LAYOUT_default( \
    _______, _______, _______, _______, _______,        _______,         /*******/ _______, _______,          _______, _______, _______, _______,   \
    _______, _______, _______, _______, _______,        _______,         /*******/ _______, _______,          _______, _______, _______, _______,   \
    _______, _______, _______, _______, _______,        _______,         /*******/ _______, _______,          _______, _______, _______, _______,   \
    _______, _______, _______, _______, _______,        _______,         /*******/ _______, _______,          _______, _______, _______, LALT_T(KC_QUOT),   \
    KC_GRV,  _______, _______, _______, _______,        _______,         /*******/ _______, _______,          _______, _______, _______, KC_BSLASH, \
    /*___*/  /*___*/  /*___*/  /*___*/  LCTL_T(KC_ESC), LSFT_T(KC_BSPC), /*******/ _______, _______ \
  ),
  ...
  [_GAMING] = LAYOUT_default( \
    ...
    /*___*/  /*___*/  /*___*/  /*___*/  KC_LGUI, KC_BSPC, /*******/ _______, _______  \
  ),

  [_LOWER] = LAYOUT_default( \
    DF(_BASE), DF(_BETA),  DF(_GAMING), _______,       _______,       RESET,      /*******/ RESET,      _______,    _______,    _______,    _______,    KC_SLEP, \
    _______,   _______,    _______,     _______,       _______,       _______,    /*******/ _______,    _______,    _______,    _______,    _______,    _______, \
    ...
    _______,   _______,    _______,     LSFT(KC_LBRC), LSFT(KC_RBRC), _______,    /*******/ KC_LBRC,    KC_RBRC,    _______,    _______,    _______,    _______, \
  ...
  [_RAISE] = LAYOUT_default( \
    ...
    _______, _______, _______, LSFT(KC_LBRC), LSFT(KC_RBRC), _______, /*******/ _______, _______, _______, _______,  _______, _______, \
